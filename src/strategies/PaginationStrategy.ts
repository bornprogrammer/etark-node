...
export class PaginationStrategy {
    ...
    public extractOutPaginationParams = async (req: Request): Promise<DBLimit> => {
        ...
        let offset: any = (pageNo - 1) * noOfRecords;
        let dbLimit: DBLimit = { limit: parseInt(noOfRecords), offset: parseInt(offset) };
        return dbLimit;
    }
    ...
    public extractOutPaginationParamsNMerge = async (req: Request, obj: any) => {
        ...
        return Object.assign(obj, { "pagination": paginationParams });
    }
}
