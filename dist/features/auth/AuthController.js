...
const AuthRequestParamCoordinator_1 = require("./AuthRequestParamCoordinator");
class AuthController extends BaseController_1.BaseController {
    ...
    constructor(authService) {
        ...
        this.login = (req, res) => __awaiter(this, void 0, void 0, function* () {
            let params = AuthRequestParamCoordinator_1.AuthRequestParamCoordinator.getInstance(req).getLoginParams();
        ...
        this.createUser = (req, res) => __awaiter(this, void 0, void 0, function* () {
            let params = AuthRequestParamCoordinator_1.AuthRequestParamCoordinator.getInstance(req).getCreateUserParams();
