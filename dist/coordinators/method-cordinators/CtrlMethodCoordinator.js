...
class CtrlMethodCoordinator extends MethodCordinator_1.default {
    ...
    constructor() {
        ...
        this.returnResp = (request, res) => __awaiter(this, void 0, void 0, function* () {
            let result = null;
            try {
                result = yield this.coordinate();
                return result;
        ...
        this.sendData = (request, res, data) => __awaiter(this, void 0, void 0, function* () {
            ResponseService_1.responseServiceIns.sendResponse(request, res, data);
        });
